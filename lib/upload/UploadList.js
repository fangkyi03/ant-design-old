        ...
        value: function render() {
            ...
            var list = items.map(function (file) {
                    ...
                    if (listType === 'picture-card' && file.status === 'uploading') {
                        ...
                        icon = React.createElement(
                            ...
                            { className: prefixCls + '-list-item-thumbnail', onClick: function onClick(e) {
                                ...
                                }, href: file.url || file.thumbUrl || file.urlid, target: '_blank', rel: 'noopener noreferrer' },
                            thumbnail
                        );
                    }
                }
                ...
                var previewIcon = showPreviewIcon ? React.createElement(
                    'a',
                    { href: file.response && file.response.data && (file.response.data.urlid || file.response.data[0].url) || file.url || file.thumbUrl, target: '_blank', rel: 'noopener noreferrer', style: file.response && file.response.data && file.response.data.urlid || file.url || file.thumbUrl ? undefined : style, onClick: function onClick(e) {
                            return _this3.handlePreview(file, e);
